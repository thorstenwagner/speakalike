...
(function () {
    const translations = {
        de: {
            ...
            text_input_placeholder: 'Strg+Shift+Enter=KI | Strg+L=Sprache | Strg+D=Signal | Strg+Shift+D=Vor-Signal | Strg+P=Privat',
            ...
            generate_only_title: 'Nur generieren, nicht abspielen',
            text_input_placeholder: 'Strg+Shift+Enter=KI | Strg+L=Sprache | Strg+D=Signal | Strg+Shift+D=Vor-Signal | Strg+P=Privat',
            ...
            toast_ai_error: (msg) => `KI-Fehler: ${msg}`,
            toast_audio_generated: 'Audio erfolgreich generiert!',
            toast_error: (msg) => `Fehler: ${msg}`,
            toast_added_to_qa: 'Zum Schnellzugriff hinzugefügt',
            toast_click_confirm: 'Nochmal klicken zum Bestätigen',
            toast_qa_cleared: 'Schnellzugriff geleert',
            toast_set_updated: (name) => `Set "${name}" aktualisiert`,
            toast_set_saved: (name) => `Set "${name}" gespeichert`,
            toast_set_loaded: (name) => `Set geladen: ${name}`,
            toast_set_deleted: (name) => `Set "${name}" gelöscht`,
            toast_audio_regenerating: 'Audio wird neu generiert...',
            toast_play_error: 'Fehler beim Abspielen',
            toast_audio_imported: 'Audio erfolgreich importiert!',
            toast_import_error: (msg) => `Fehler beim Import: ${msg}`,
            toast_voices_loaded: (n) => `${n} Stimmen geladen`,
            toast_no_voices: 'Keine Stimmen gefunden. API Key korrekt?',
            toast_voices_error: 'Fehler beim Laden der Stimmen',
            toast_repeat_error: (msg) => `Fehler beim Wiederholen: ${msg}`,
            toast_mic_not_configured: 'Bitte zuerst ein Mikrofon-Gerät in den Einstellungen konfigurieren (z.B. VB-Cable)',
            toast_mic_enabled: '🎙️ Mikrofon-Ausgabe aktiviert – Sprache wird auch über das virtuelle Mikrofon gesendet',
            toast_mic_disabled: '🎤 Mikrofon-Ausgabe deaktiviert',
            toast_mic_toggle_error: 'Fehler beim Umschalten der Mikrofon-Ausgabe',
            toast_mic_select_first: 'Bitte zuerst ein Mikrofon-Gerät auswählen',
            toast_mic_test_playing: '🔊 Testton wird abgespielt...',
            toast_mic_test_ok: '✅ Testton abgespielt – wenn Sie ihn in der Telefon-App hören, funktioniert die Verbindung!',
            toast_mic_test_error: (msg) => `❌ Testton fehlgeschlagen: ${msg}`,
            toast_no_sets: 'Keine Sets vorhanden',
            toast_privacy_on: '🔒 Privacy-Modus aktiviert',
            toast_privacy_off: '🔓 Privacy-Modus deaktiviert',
            toast_ai_on: 'KI-Korrektur aktiviert',
            toast_ai_off: 'KI-Korrektur deaktiviert',
            toast_items_saved: (n) => `${n} Eintrag${n > 1 ? 'e' : ''} dauerhaft gespeichert`,
            toast_lang_changed: (lang) => `Sprache: ${lang}`,
            toast_signal_on: '🔔 Vor-Signal aktiviert',
            toast_signal_off: '🔕 Vor-Signal deaktiviert',
            toast_voice_selected: (name) => `Stimme: ${name}`,
            toast_generated_added: 'Generiert & zum Schnellzugriff hinzugefügt',
        },
        en: {
            // Header
            ...
            text_input_placeholder: 'Ctrl+Shift+Enter=AI | Ctrl+L=Language | Ctrl+D=Signal | Ctrl+Shift+D=Pre-Signal | Ctrl+P=Privacy',
            ...
            generate_only_title: 'Generate only, do not play',
            text_input_placeholder: 'Ctrl+Shift+Enter=AI | Ctrl+L=Language | Ctrl+D=Signal | Ctrl+Shift+D=Pre-Signal | Ctrl+P=Private',
            ...
            toast_ai_error: (msg) => `AI error: ${msg}`,
            toast_audio_generated: 'Audio generated successfully!',
            toast_error: (msg) => `Error: ${msg}`,
            toast_added_to_qa: 'Added to quick access',
            toast_click_confirm: 'Click again to confirm',
            toast_qa_cleared: 'Quick access cleared',
            toast_set_updated: (name) => `Set "${name}" updated`,
            toast_set_saved: (name) => `Set "${name}" saved`,
            toast_set_loaded: (name) => `Set loaded: ${name}`,
            toast_set_deleted: (name) => `Set "${name}" deleted`,
            toast_audio_regenerating: 'Regenerating audio...',
            toast_play_error: 'Playback error',
            toast_audio_imported: 'Audio imported successfully!',
            toast_import_error: (msg) => `Import error: ${msg}`,
            toast_voices_loaded: (n) => `${n} voice${n > 1 ? 's' : ''} loaded`,
            toast_no_voices: 'No voices found. Is the API key correct?',
            toast_voices_error: 'Error loading voices',
            toast_repeat_error: (msg) => `Repeat error: ${msg}`,
            toast_mic_not_configured: 'Please configure a microphone device in settings first (e.g. VB-Cable)',
            toast_mic_enabled: '🎙️ Microphone output enabled – speech will also be sent via the virtual microphone',
            toast_mic_disabled: '🎤 Microphone output disabled',
            toast_mic_toggle_error: 'Error toggling microphone output',
            toast_mic_select_first: 'Please select a microphone device first',
            toast_mic_test_playing: '🔊 Playing test tone on mic device...',
            toast_mic_test_ok: '✅ Test tone played – if you hear it in the phone app, the connection works!',
            toast_mic_test_error: (msg) => `❌ Test tone failed: ${msg}`,
            toast_no_sets: 'No sets available',
            toast_privacy_on: '🔒 Privacy mode enabled',
            toast_privacy_off: '🔓 Privacy mode disabled',
            toast_ai_on: 'AI correction enabled',
            toast_ai_off: 'AI correction disabled',
            toast_items_saved: (n) => `${n} item${n > 1 ? 's' : ''} permanently saved`,
            toast_lang_changed: (lang) => `Language: ${lang}`,
            toast_signal_on: '🔔 Pre-signal enabled',
            toast_signal_off: '🔕 Pre-signal disabled',
            toast_voice_selected: (name) => `Voice: ${name}`,
            toast_generated_added: 'Generated & added to quick access',
        }
    };
